...
instr sinkingBreakDiskin
    ...
    iBreakSegment = p5
    kpitchFactor = p6
    SsinkingFilePath sprintfk "instruments/breakBeatInstruments/sinkingBreak/sinkingBreak%i.wav", iBreakSegment

    asinkingL, asinkingR breakSamplerDiskin SsinkingFilePath, gisinkingBreakSegmentLengths[iBreakSegment], iSkipTimeInBeats, kpitchFactor
