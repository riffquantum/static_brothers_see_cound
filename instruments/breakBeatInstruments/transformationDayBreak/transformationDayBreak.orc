...
instr transformationDayBreakDiskin
    ...
    iBreakSegment = p5
    kpitchFactor = p6
    StransformationDayFilePath sprintfk "instruments/breakBeatInstruments/transformationDayBreak/transformationDayBreak%i.wav", iBreakSegment

    atransformationDayL, atransformationDayR breakSamplerDiskin StransformationDayFilePath, gitransformationDayBreakSegmentLengths[iBreakSegment], iSkipTimeInBeats, kpitchFactor
