...
instr gettinHappyBreakDiskin
    iSkipTimeInBeats = p4
    iBreakSegment = p5
    SgettinHappyFilePath sprintfk "instruments/gettinHappyBreak/gettinHappyBreak%i.wav", iBreakSegment
    ...
    agettinHappyL, agettinHappyR diskin SgettinHappyFilePath, kpitch, iSkipTime, iwraparound, iformat, iskipinit
