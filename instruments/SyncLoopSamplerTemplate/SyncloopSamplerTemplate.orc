...
instr SyncloopSamplerTemplateMixerChannel
    ...
    aSyncloopSamplerTemplateL inleta "SyncloopSamplerTemplateInL"
    aSyncloopSamplerTemplateR inleta "SyncloopSamplerTemplateInR"

    kSyncloopSamplerTemplateFader = gkSyncloopSamplerTemplateFader
    kSyncloopSamplerTemplatePan = gkSyncloopSamplerTemplatePan
    kSyncloopSamplerTemplateEqBass = gkSyncloopSamplerTemplateEqBass
    kSyncloopSamplerTemplateEqMid = gkSyncloopSamplerTemplateEqMid
    kSyncloopSamplerTemplateEqHigh = gkSyncloopSamplerTemplateEqHigh

    aSyncloopSamplerTemplateL, aSyncloopSamplerTemplateR threeBandEqStereo aSyncloopSamplerTemplateL, aSyncloopSamplerTemplateR, kSyncloopSamplerTemplateEqBass, kSyncloopSamplerTemplateEqMid, kSyncloopSamplerTemplateEqHigh

    if kSyncloopSamplerTemplatePan > 100 then
        kSyncloopSamplerTemplatePan = 100
    elseif kSyncloopSamplerTemplatePan < 0 then
        kSyncloopSamplerTemplatePan = 0
    endif

    aSyncloopSamplerTemplateL = (aSyncloopSamplerTemplateL * ((100 - kSyncloopSamplerTemplatePan) * 2 / 100)) * kSyncloopSamplerTemplateFader
    aSyncloopSamplerTemplateR = (aSyncloopSamplerTemplateR * (kSyncloopSamplerTemplatePan * 2 / 100)) * kSyncloopSamplerTemplateFader
