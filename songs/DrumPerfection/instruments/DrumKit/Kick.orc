stereoRoute "KickMixerChannel", "DrumKitKickLPFInput"
stereoRoute "KickMixerChannel", "SineWaveForKick"
...
instr Kick
  ; event_i "i", "MuffledKick", 0, p3, p4, p5
  event_i "i", "LinnKick", 0, p3, p4, p5
  event_i "i", "EightOhEightKick", 0, p3, p4, p5

  gkSineWaveForKickFrequency = port(giSineWaveForKickInitialFrequency * p5, .01)
endin
