instr DrumPattern1
  ...
  until iMeasureCount * iBeatsPerMeasure >= iPatternLength do
    ...
    beatScoreline "Snare", iBaseTime+.5, .01, 70,  .75
    ; beatScoreline "Rim", iBaseTime+5/8, .01, 40,  .8
    beatScoreline "Snare", iBaseTime+1.5, .01, 70,  .75
    beatScoreline "Snare", iBaseTime+2.5, .01, 70,  .75
    beatScoreline "Snare", iBaseTime+3.5, .01, 70,  .75
