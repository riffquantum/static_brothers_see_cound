instr drumPattern1
  ...
  beatScorelineS( "FunkyDrummerBreak", 1, .55, {{ .55 }} )
  beatScorelineS( "FunkyDrummerBreak", 3, .55, {{ .55 }} )

  if iVariation == 0 then
    beatScorelineS("LoserInTheEndBreak", 0, 4, {{  2 }})
  elseif iVariation == 1 then
    beatScorelineS("LoserInTheEndBreak", 0, 4, {{  9 }})
  elseif iVariation == 2 then
    beatScorelineS("LoserInTheEndBreak", 0, 4, {{  8 }})
  elseif iVariation == 3 then
    beatScorelineS("LoserInTheEndBreak", 0, 4, {{  6 }})
  endif
endin
