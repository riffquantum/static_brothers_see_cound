; This file includes default mixer routing for new songs. This file
; can be overriden in song files for custom effects routing,
; bussing, grouping.
...
connect "thigpen1MixerChannel", "thigpen1OutL", "Mixer", "MixerInL"
connect "thigpen1MixerChannel", "thigpen1OutR", "Mixer", "MixerInR"
